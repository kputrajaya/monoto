...
function SvgComponent(props) {
  return (
    <svg viewBox="0 0 702.48 896.93" {...props}>
      <defs>
        <pattern
          ...
          width={12}
          height={12}
          patternTransform="matrix(-1 0 0 1 -6.58 -23.89)"
        ...
        <pattern
          id="prefix__New_Pattern-3"
          data-name="New Pattern"
          width={12}
          height={12}
          patternTransform="matrix(-1 0 0 1 -.98 -28.49)"
          patternUnits="userSpaceOnUse"
          viewBox="0 0 12 12"
        >
          <path className="prefix__cls-1" d="M0 0h12v12H0z" />
        ...
        <pattern
          id="prefix__New_Pattern-5"
          data-name="New Pattern"
          width={12}
          height={12}
          patternTransform="matrix(-1 0 0 1 -2.9 -27.94)"
          patternUnits="userSpaceOnUse"
          viewBox="0 0 12 12"
        >
          <path className="prefix__cls-1" d="M0 0h12v12H0z" />
        ...
        <pattern
          id="prefix__New_Pattern-7"
          data-name="New Pattern"
          width={12}
          height={12}
          patternTransform="matrix(-1 0 0 1 -13.52 -28.36)"
          patternUnits="userSpaceOnUse"
          viewBox="0 0 12 12"
        >
          <path className="prefix__cls-1" d="M0 0h12v12H0z" />
      ...
      <g id="prefix__Layer_2" data-name="Layer 2">
        <g id="prefix__Layer_1-2" data-name="Layer 1">
          <path
            d="M623.07 150.47C570.53 85.72 499.5 27.27 417.55 16.35s-174.81 25.72-257.13 90.46S6.32 264.42.4 363.21s54.2 203.3 136.52 280.44a513.45 513.45 0 0060.61 48.84A342.4 342.4 0 01235 680.57h-.05c4.91-15.34 10.4-31.58 10.74-49.66.6-32.3-4-51.69-3.37-104.25.47-41.5 38.48-85.8 92.5-85.8s83 36.08 88.39 72.72c5.48 37.47-.77 68.5.79 113.81.72 20.62 7.08 36.6 13.78 53.19h-.06A381 381 0 01482.33 694c41.36-41.93 76-99.8 109.29-148.91 52.35-77 101.93-132.45 109.7-195.53 7.96-63.31-25.9-134.34-78.25-199.09z"
            fill="#f2f2f2"
          />
          <path
            className="prefix__cls-4"
            d="M189 892.53c2.07-16.57 5.35-43.27 10.7-68M480.67 892.53c-2.07-16.57-5.35-43.27-10.7-68"
          />
          <path
            d="M402.83 298.32c-5.09 1.79-7.95 4.23-9.57 8.47"
            strokeWidth={2.83}
          ...
          <path
            className="prefix__cls-14"
            d="M364.11 669.49c65.52 4.43 122.76 22.57 155.26 41.57 22.09 22.44 38.06 171.51 33.23 182.21M113.09 895.68c-2.07-25.54 9.32-116.62 44.53-184.62 45.87-25.41 95.82-37.73 144.19-41.39"
          />
          <path
            className="prefix__cls-4"
            d="M189 893.27c2.07-16.57 5.35-43.27 10.7-68M480.67 893.27c-2.07-16.57-5.35-43.27-10.7-68"
          />
          <path
            className="prefix__cls-14"
            d="M271.7 572.57a14.63 14.63 0 11-1.52-27.46M399.36 544.51h.77a14.63 14.63 0 11-2.51 29"
          />
          <path
            className="prefix__cls-11"
            d="M393.81 307.89c-14.76-11.52-18.4 1.35-20.71 9s-2.1 21.11 9.43 20.82c10.14 9.1 19.58-2.67 22.47-8.65s10-18.93-11.19-21.17z"
          />
          <path
            d="M402.83 299.06c-5.09 1.8-7.95 4.24-9.57 8.47"
            strokeWidth={2.83}
            strokeLinejoin="round"
            strokeLinecap="round"
            stroke="#000"
          ...
          />
          <path
            d="M307.89 384.64A17.13 17.13 0 11325 401.77a17.13 17.13 0 01-17.11-17.13z"
          ...
          />
          <path
            d="M512.17 394.3l-17.8 7.13 2.72-19 2.73-19 15.08 11.85 15.1 11.89z"
          ...
          <path
            className="prefix__cls-14"
            d="M399 540a115.88 115.88 0 01.7 12.74c0 47.72-29 86.41-64.84 86.41a49.8 49.8 0 01-15.73-2.56M344.9 492.3c-22.06 20.19-52.39 37.51-74.12 46.8M385.5 532.21A113.37 113.37 0 00399 540M342.64 489a164.42 164.42 0 0014.61 18.49"
          />
          <path
            d="M430.19 17.13a17.14 17.14 0 1117.14 17.13 17.14 17.14 0 01-17.14-17.13z"
            fill="url(#prefix__New_Pattern-7)"
            fillRule="evenodd"
          />
          <path
            className="prefix__cls-12"
            d="M130.62 475a16 16 0 1116 16 16 16 0 01-16-16zM485.13 468.21a9.31 9.31 0 119.31 9.31 9.31 9.31 0 01-9.31-9.31z"
          />
        </g>
      </g>
    </svg>
